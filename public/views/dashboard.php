        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <a href="index.php?page=employees" class="btn btn-primary btn-sm">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="index.php?page=leave-requests" class="btn btn-info w-100">
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="index.php?page=departments" class="btn btn-secondary w-100">
